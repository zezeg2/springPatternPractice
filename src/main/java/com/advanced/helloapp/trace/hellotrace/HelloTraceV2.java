...
public class HelloTraceV2 {
    ...
    public TraceStatus beginSync(TraceId prevTraceId, String message) {
        TraceId currentId = prevTraceId.createNextId();
        Long startTimeMs = System.currentTimeMillis();
        log.info("[{}] {}{}", currentId.getId(), addSpace(START_PREFIX,
                currentId.getLevel()), message);
        return new TraceStatus(currentId, startTimeMs, message);
    }
